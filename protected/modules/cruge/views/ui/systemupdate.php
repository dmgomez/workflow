...
<div class="data">
	<h2 class="data-title"><?php echo ucwords(CrugeTranslator::t("opciones de sesion"));?></h2>
	<div class="data-body">
		<div class='col'>
...
<!--<div class="data">
	<h2 class="data-title"><?php //echo ucwords(CrugeTranslator::t("opciones de registro de usuarios"));?></h2>
	<div class="data-body">
		<div class='col'>
...
<!--<div class="data">
	<h2 class="data-title"><?php //echo ucwords(CrugeTranslator::t("terminos y condiciones de registro"));?></h2>
	<div class="data-body">
		...
		<hr/>
			...
			<?php /*echo $form->textArea($model,'terms'
				,array('rows'=>10,'cols'=>50'class'=>'span9'));*/ ?>
