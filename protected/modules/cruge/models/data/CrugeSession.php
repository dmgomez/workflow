    ...
    */
    ...
    public function rules()
    {
        ...
        return array(
            ...
            array('idsession, iduser, sessionname, created, expire, status, ipaddress', 'safe', 'on' => 'search'),
        );
    }
    ...
    public function search()
    {
        ...
        $criteria->with = array("user"=>array('alias'=>'crugestoreduser'));

        $criteria->compare('idsession', $this->idsession, true);
        $criteria->compare('iduser', $this->iduser, true);
        $criteria->compare('crugestoreduser.sessionname', $this->sessionname, true);
        ...
        return new CActiveDataProvider($this, array(
            ...
            'sort' => array(
                ...
                'attributes' => array(
                    'sessionname'=>array(
                        'asc'=>'crugestoreduser.username',
                        'desc'=>'crugestoreduser.username desc',
                    ),
                    'created'=>array(
                        'asc'=>'created',
                        'desc'=>'created desc',
