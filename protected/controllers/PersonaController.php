...
class PersonaController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			...
			array('allow', // allow authenticated user to perform 'create' and 'update' actions
				'actions'=>array('create','update', 'admin','delete', 'DeleteGrid', 'buscarCedula'),
				'users'=>array('@'),
			),
			array('allow', // allow admin user to perform 'admin' and 'delete' actions
				'actions'=>array('admin','delete', 'DeleteGrid', 'buscarCedula'),
				'users'=>array('admin'),
			),
	...
	*/
	...
	public function actionBuscarCedula()
	{
		...
		$model = Persona::model()->findByAttributes( array('nacionalidad_persona'=>$nacionalidad, 'cedula_persona'=>$cedula) );
		
		if($model)
		{

			$result = array('success' => false, 'message' => 'El número de cédula que ingresó ya se encuentra registrado.');	
