...
class EstadoActividadController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			...
			array('allow', // allow admin user to perform 'admin' and 'delete' actions
				'actions'=>array('admin','delete', 'DeleteGrid'),
				'users'=>array('admin'),
			),
	...
	*/
	...
	public function actionCreate()
	{
		...
		{
			$model->attributes=$_POST['EstadoActividad'];
			if($model->save())
			{
	...
	{
		$dataProvider=new CActiveDataProvider('EstadoActividad');
	...
	{
		$model=new EstadoActividad('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['EstadoActividad']))
			$model->attributes=$_GET['EstadoActividad'];
	 ...
	 * @return EstadoActividad the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=EstadoActividad::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param EstadoActividad $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='estado-actividad-form')
		{
