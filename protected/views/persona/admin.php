...
$this->breadcrumbs=array(
	Persona::getTitulo(false,true),
);

$this->menu=array(
	/*array('label'=>'Lista Persona', 'url'=>array('index')),*/
	array('label'=>'Agregar '.Persona::getTitulo(false,false), 'url'=>array('create'), 'icon'=>'icon-plus'),
);
...
<h1>Registro de <?php echo Persona::getTitulo(false,true); ?></h1>
...
<?php $this->widget('bootstrap.widgets.TbGridView', array(
	...
	'columns'=>array(
		...
		array('name' => 'cedula_persona', 'value' => '$data->getCedulaCompleta()'),
		'nombre_persona',
		'apellido_persona',
		'direccion_persona',
		/*
		...
		array(
			...
			'buttons'=>array(
				...
				'delete'=>array(
					...
					'url'=>'Yii::app()->createUrl("persona/deleteGrid", array("id" => $data->id_persona))',
					'click' => "function(e){
...
<?php $this->widget('bootstrap.widgets.TbButton', array(
	...
	'url'=>$this->createUrl('persona/admin'),
